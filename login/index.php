...
<body>
    <div class="container">
        ...
        <div class="card card-login card-login-2">
            <button type="button" class="btn btn-secondary card-login2">Create Account</button>
            <button type="button" class="btn btn-secondary card-login2">Reset Password</button>
        </div>
    </div>
