...
var hljs = function () {
  ...
  const Y = n, Q = i, ee = Symbol("nomatch"), te = n => {
      ...
      ; const a = "Could not find the language '{}', did you forget to load/include a language module?", l = {
        ...
        function h(e, t) {
          return e.scope && "string" == typeof e.scope && M.openNode(_.classNameAliases[e.scope] || e.scope),
            e.beginScope && (e.beginScope._wrap ? (u(R, _.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap),
              R = "") : e.beginScope._multi && (d(e.beginScope, t), R = "")), S = Object.create(e, {
                parent: {
                  value: S
                }
              }), S
        ...
        let w = {}; function y(i, o) {
          ...
          ; if (!_) throw W(a.replace("{}", e)), Error('Unknown language: "' + e + '"')
            ; const k = V(_); let N = "", S = o || k; const v = {}, M = new p.__emitter(p); (() => {
              const e = []
              ...
              } return M.finalize(), N = M.toHTML(), {
                language: e,
                value: N, relevance: j, illegal: !1, _emitter: M, _top: S
              }
            } catch (t) {
              if (t.message && t.message.includes("Illegal")) return {
                ...
                illegal: !0, relevance: 0, _illegalBy: {
                  ...
                  context: n.slice(A - 100, A + 100), mode: t.mode, resultSoFar: N
                }, _emitter: M
              }; if (r) return {
        ...
        })(e), s = t.filter(O).filter(N).map((t => E(t, e, !1)))
    ...
    "undefined" != typeof window && window.addEventListener && window.addEventListener("DOMContentLoaded", (() => {
      ...
      r = !1
    }, n.safeMode = () => { r = !0 }, n.versionString = "11.8.0", n.regex = {
      concat: h,
